...
public class CredentialTests {
	...
	public void credentialRestController_findAll_RowsCount_Test() {
		...
		/*when a client object call a method 
		 * we can define the behavior for service object for that method
		 * so it dont need to connect to real data, 
		 * however client object can test the other functionality
		 */
